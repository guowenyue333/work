 ...
 *
 ************************************************************************/
#ifndef _IMX338SSMIPI_SENSOR_H
#define _IMX338SSMIPI_SENSOR_H
...
extern void read_imx338ss_SPC(BYTE *data);
extern void read_imx338ss_DCC(kal_uint16 addr, BYTE *data, kal_uint32 size);
