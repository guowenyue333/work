 ...
 *=====================================================
 ************************************************************************/
#define PFX "IMX338SS_camera_sensor"
...
/*support ZHDR*/
/* #define IMX338SS_ZHDR */

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static BYTE imx338ss_SPC_data[352] = { 0 };


static struct imgsensor_info_struct imgsensor_info = {
	/* record sensor id defined in Kd_imgsensor.h */
	.sensor_id = IMX338SS_SENSOR_ID,
...
#define IMX338SSMIPI_MaxGainIndex (115)
kal_uint16 IMX338SSMIPI_sensorGainMapping[IMX338SSMIPI_MaxGainIndex][2] = {
	{64, 0},
	{65, 8},
	{66, 16},
	{67, 25},
...
static kal_uint32 imx338ss_ATR(UINT16 DarkLimit, UINT16 OverExp)
{
	...
	/*pr_debug("bk_ imx338ss_ATR 0x%x-%x, 0x%x-%x, 0x%x-%x DarkLimit %d",
...
static void imx338ss_set_pd_focus_area(MUINT32 startpos, MUINT32 size)
{
...
static void imx338ss_get_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void imx338ss_set_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void imx338ss_apply_SPC(void)
{
	...
	read_imx338ss_SPC(imx338ss_SPC_data);

	tosend = 0;
	puSendCmd[tosend++] = (char)(start_reg >> 8);
	puSendCmd[tosend++] = (char)(start_reg & 0xFF);
	memcpy((void *)&puSendCmd[tosend], imx338ss_SPC_data, 352);
	tosend += 352;
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	pr_debug("[IMX338SSMIPI]enter IMX338SSMIPIGain2Reg function\n");
	for (iI = 0; iI < IMX338SSMIPI_MaxGainIndex; iI++) {
		if (gain <= IMX338SSMIPI_sensorGainMapping[iI][0])
			return IMX338SSMIPI_sensorGainMapping[iI][1];


	}
	pr_debug("exit IMX338SSMIPIGain2Reg function\n");
	return IMX338SSMIPI_sensorGainMapping[iI - 1][1];
}
...
#endif
static kal_uint16 imx338ss_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_imx338ss_zvhdr_on[] = {
	0x30b1, 0x00,
	0x30c6, 0x00,
	0x30b2, 0x00,
	0x30b3, 0x00,
...
kal_uint16 addr_data_pair_imx338ss_zvhdr_off[] = {
	0x30b4, 0x00,
	0x30b5, 0x00,
	0x30b6, 0x00,
	0x30b7, 0x00,
...
static kal_uint16 zvhdr_setting(void)
{
	...
	if (imgsensor.hdr_mode == 9) {
		imx338ss_table_write_cmos_sensor(addr_data_pair_imx338ss_zvhdr_on,
		   sizeof(addr_data_pair_imx338ss_zvhdr_on) / sizeof(kal_uint16));
	} else {
		imx338ss_table_write_cmos_sensor(addr_data_pair_imx338ss_zvhdr_off,
		  sizeof(addr_data_pair_imx338ss_zvhdr_off) / sizeof(kal_uint16));
	}
	return 0;

}

kal_uint16 addr_data_pair_init_imx338ss[] = {
...
{
	pr_debug("E\n");
	imx338ss_table_write_cmos_sensor(addr_data_pair_init_imx338ss,
	    sizeof(addr_data_pair_init_imx338ss)/sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_preview_imx338ss[] = {
	0x0100, 0x00,
...
kal_uint16 addr_data_pair_preview_imx338ss_hdr[] = {
	0x0100,	0x00,
...
static void preview_setting(void)
{
	if ((imgsensor.hdr_mode == 2) || (imgsensor.hdr_mode == 9)) {
		imx338ss_table_write_cmos_sensor(
		addr_data_pair_preview_imx338ss_hdr,
		sizeof(addr_data_pair_preview_imx338ss_hdr) / sizeof(kal_uint16));

		imx338ss_ATR(3, 3);
		zvhdr_setting();
	} else {
		imx338ss_table_write_cmos_sensor(
		addr_data_pair_preview_imx338ss,
		sizeof(addr_data_pair_preview_imx338ss) / sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_capture_imx338ss[] = {
	0x0100, 0x00,
...
kal_uint16 addr_data_pair_capture_imx338ss_hdr[] = {
	0x0100, 0x00,
	0x0114, 0x03,
	0x0220, 0x23,
	0x0221, 0x11,
...
kal_uint16 addr_data_pair_capture_imx338ss_pdaf_on[] = {
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if ((imgsensor.hdr_mode == 2) || (imgsensor.hdr_mode == 9)) {
		imx338ss_table_write_cmos_sensor(
		addr_data_pair_capture_imx338ss_hdr,
		sizeof(addr_data_pair_capture_imx338ss_hdr) / sizeof(kal_uint16));

		zvhdr_setting();
	} else {
		imx338ss_table_write_cmos_sensor(addr_data_pair_capture_imx338ss,
		    sizeof(addr_data_pair_capture_imx338ss) / sizeof(kal_uint16));

		zvhdr_setting();
	}
	if (imgsensor.pdaf_mode == 1) {
		imx338ss_table_write_cmos_sensor(
		addr_data_pair_capture_imx338ss_pdaf_on,
	    sizeof(addr_data_pair_capture_imx338ss_pdaf_on) / sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_video_imx338ss[] = {
	0x0100, 0x00,
	0x0114, 0x03,
	0x0220, 0x00,
	0x0221, 0x11,
...
kal_uint16 addr_data_pair_video_imx338ss_hdr[] = {
	0x0100, 0x00,
	0x0114, 0x03,
	0x0220, 0x23,
	0x0221, 0x11,
...
static void normal_video_setting(kal_uint16 currefps)
{
	pr_debug("E! %s:%d\n", __func__, currefps);
	if ((imgsensor.hdr_mode == 2) || (imgsensor.hdr_mode == 9)) {
		imx338ss_table_write_cmos_sensor(addr_data_pair_video_imx338ss_hdr,
		  sizeof(addr_data_pair_video_imx338ss_hdr) / sizeof(kal_uint16));

		zvhdr_setting();
	} else {
		imx338ss_table_write_cmos_sensor(addr_data_pair_video_imx338ss,
		    sizeof(addr_data_pair_video_imx338ss) / sizeof(kal_uint16));

		zvhdr_setting();
	}
}

kal_uint16 addr_data_pair_hs_video_imx338ss[] = {	/*720 120fps */
	0x0100, 0x00,
...
{
	imx338ss_table_write_cmos_sensor(addr_data_pair_hs_video_imx338ss,
		sizeof(addr_data_pair_hs_video_imx338ss) / sizeof(kal_uint16));
	zvhdr_setting();
}

kal_uint16 addr_data_pair_slim_video_imx338ss[] = {
	0x0100, 0x00,
...
{
	/* @@video_720p_60fps */
	imx338ss_table_write_cmos_sensor(addr_data_pair_slim_video_imx338ss,
	    sizeof(addr_data_pair_slim_video_imx338ss) / sizeof(kal_uint16));
...
static kal_uint32 imx338ss_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		read_imx338ss_DCC((kal_uint16) (*feature_data),
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		imx338ss_awb_gain(pSetSensorAWB);
		break;
	...
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		...
		imx338ss_set_pdaf_reg_setting(
			(*feature_para_len) / sizeof(UINT32), feature_data_16);
		break;

	case SENSOR_FEATURE_SET_PDFOCUS_AREA:
		pr_debug(
		    "SENSOR_FEATURE_SET_IMX338SS_PDFOCUS_AREA Start Pos=%d, Size=%d\n",
		    (UINT32) *feature_data, (UINT32) *(feature_data + 1));

		imx338ss_set_pd_focus_area(*feature_data, *(feature_data + 1));
		break;
		/*End of PDAF */
...
UINT32 IMX338SS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
